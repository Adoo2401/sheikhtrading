  ...
  return (
    <div className="container mx-auto lg:grid lg:grid-cols-8 gap-6 py-24 px-12 items-center place-content-center justify-center">
      ...
      <div className="col-span-2 flex flex-col space-y-4 items-center justify-center text-center">
        ...
        <p className="text-2xl font-medium text-gray-600">Warehousing and Distribution</p>
        <p className="text-gray-600">
        Streamline your supply chain with our state-of-the-art warehousing and distribution services. From storage to order fulfillment.
        </p>
      </div>
      <div className="col-span-2 flex flex-col space-y-4 items-center justify-center text-center">
