            ...
            <div className="col-span-1 flex flex-row space-x-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 font-medium">
                  Unit 3 Building#65, District 3, jiangnan, Yiwu
                </p>
              </div>
            </div>
            <div className="col-span-1 flex flex-row space-x-3">
            ...
            <div className="col-span-1 space-y-8">
              ...
              <div className="flex flex-col space-y-1">
                <div className="flex flex-row items-center space-x-2">
                  ...
                  <p className="text-gray-500">Global Freight Forwarding</p>
                </div>
                <div className="flex flex-row items-center space-x-2">
                  <FaAngleRight className="w-8 h-8 text-gray-500  p-1" />
                  <p className="text-gray-500">Customs Clearance Solutions</p>
                </div>
                <div className="flex flex-row items-center space-x-2">
                  <FaAngleRight className="w-8 h-8 text-gray-500  p-1" />
                  <p className="text-gray-500">Warehousing and Distribution</p>
                </div>
                <div className="flex flex-row items-center space-x-2">
                  <FaAngleRight className="w-8 h-8 text-gray-500  p-1" />
                  <p className="text-gray-500">Trade Compliance Consulting</p>
                </div>
                <div className="flex flex-row items-center space-x-2">
                  <FaAngleRight className="w-8 h-8 text-gray-500  p-1" />
                  <p className="text-gray-500">Logistics Technology Solutions</p>
                </div>
              </div>
            </div>
            <div className="col-span-1 space-y-8">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-row items-center space-x-4">
                  ...
                  <p className="text-gray-500">(+86) 579 899 693 33</p>
                </div>
                <div className="flex flex-row items-center space-x-4">
                ...
                <div className="flex flex-row items-center space-x-4">
                  ...
                  <p className="text-gray-500"> 2596980473@qq.com</p>
                </div>
                <div className="flex flex-row items-center space-x-4">
